import 'package:myApp/helpers/responsive_helper.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  _buildArticlesGrid(MediaQueryData mediaQuery) {
    ...
    _articles.forEach((article) {
      tiles.add(_buildArticlesTile(article, mediaQuery));
    });
  ...
  _buildArticlesTile(Article article, MediaQueryData mediaQuery) {
    return GridTile(
